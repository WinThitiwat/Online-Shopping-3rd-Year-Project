                    ...
                    <form action="confirmOrder.jsp" method="post">
                        ...
                        <div class="personalInfoForm">
                            ...
                            <div class="personalInfo">
                                ...
                                <textarea type="text" name="address"  placeholder="" required="required" maxlength="100"> </textarea>
                            </div>
                        </div>
                        <br><hr>
                        <div class="paymentMethodForm">
                            <div class="personalInfo">
                                ...
                                <div class="radioGroup">
                                    <input type="radio" name="group1" value="Cash" class="active" >By Cash<br>
                                    <input type="radio" name="group1" value="CreditCard" disabled> By Credit Card<br>
                                    <input type="radio" name="group1" value="VisaCard" disabled> By Visa Card<br>
                                    <input type="radio" name="group1" value="Alipay" disabled> By Alipay<br>

                                </div>
                            </div>
                        </div>
                        <div>
                            <button type="submit" class="float_r" style="width:120px; height: 50px; font-size: 20px;">Next >></button>
                        </div>
                    </form>
                </div>
            </div>
